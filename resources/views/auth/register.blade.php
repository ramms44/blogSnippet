...
@push('css')
    ...
    <link href="{{ asset('assets/frontend/css/auth/flags.css') }}" rel="stylesheet">
...
@push('js')
    ...
    <script src="{{ asset('assets/frontend/js/jquery.flagstrap.min.js') }}"></script>
    <script src="{{ asset('assets/frontend/js/jquery.flagstrap.js') }}"></script>
    <script>
        $('#basic').flagStrap();
